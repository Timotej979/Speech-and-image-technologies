...
"""for k in range(n_total):
    ...
    temp_sig = sinsum(np.ndarray.tolist(temp_formant), np.ndarray.tolist(temp_amplitude), T_step, fs)
    
    finalsig = np.append(finalsig, temp_sig, 0)
    
wavfile.write("final.wav", fs, finalsig)
"""
